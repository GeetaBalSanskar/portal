...
const VerifyEmailV2 = ({ mode }: { mode: SystemMode }) => {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const res = await genrateotpformail(Email)
      if (res?.success) {
    ...
    <div className='flex bs-full justify-center'>
      ...
      <div className='flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px]'>
        ...
        <div className='flex flex-col gap-6 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-11 sm:mbs-14 md:mbs-0'>
          ...
          <Typography>
  Click the <strong>Send</strong> button to receive an activation link on your registered email (<span className='font-medium' style={{ color: 'inherit' }}>ashok@finsova.org</span>) and mobile number (<span className='font-medium' style={{ color: 'inherit' }}>7014265848</span>). Please check your inbox and SMS, and follow the instructions to verify your account.
</Typography>
          </div>
                {msgState && (
